...
handler.handleReqRes=(req,res)=>{
    ...
    // as handler is out of this file so we have to sent all the request property to there.so, making an object, when we call the choosenHandler we pass the requestProperty 
